  ...
  fluidRow(
    ...
    column(6, style = "padding: 20px",
      ...
      fluidRow(
        ...
        column(8, selectInput("model", "Model", c("User-based collaborative filtering", "Item-based collaborative filtering", "Random Forest", "Extreme Gradient Boosting"), width = "100%"))
      ),
